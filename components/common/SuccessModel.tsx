...
import "../../assets/style/common/_successModel.scss"

const SuccessModel = () => {
    return (
        <>
            <div className='successModel_wrap'>
                <div className="success_main_wrap">
                    <div className="success_wrap">
                        <div className="row mx-auto">
                            <div className="col-12">
                                <div className="checkmark">
                                    <svg className="checkmark_ok" height="19" viewBox="0 0 19 19" width="19"
                                    ...
                                    <svg className="checkmark__back" height="115" viewBox="0 0 120 115" width="120"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div className="checkmark_title">
                        <h3 className="h3_title">Thank You!</h3>
                        <p>Your Request has been successfully submitted, we will be contacting you soon!</p>
                    </div>
                </div>
            </div>
        </>
