            ...
            <Col sm={12} md={6} lg={6} xl={6}>
              <article className='wallet-banner-article'>
                ...
                <div className='wallet-banner-btn-wrap'>
                  <button type='button' className='btn wallet-banner-btn' onClick={()=>  window.open("https://www.apple.com/in/app-store/", '_ blank')}>
                  ...
                  <button type='button' className='btn wallet-banner-btn' onClick={()=>  window.open("https://play.google.com/store/apps/details?id=com.sliceledger.slice&hl=en&gl=US", '_ blank')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="211" height="62" viewBox="0 0 211 62" fill="none">
                      <path d="M211 0H0V30V62H191L211 42V0Z" fill="white" />
                    </svg>
                    <div className='wallet-banner-btn-icn'>
